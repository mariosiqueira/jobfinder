...
$routes = (Object) [ //rotas nomeadas e suas respectivas url's
    ...
    "salvar_mensagem"=> "http://$_SERVER[HTTP_HOST]/usuarios/salvar_mensagem",
    "login"=> "http://$_SERVER[HTTP_HOST]/login",
    "cadastro"=> "http://$_SERVER[HTTP_HOST]/register",
    "jobs"=> "http://$_SERVER[HTTP_HOST]/jobs$filter",
    "jobs_filter"=> "http://$_SERVER[HTTP_HOST]/jobs/filter",
    ...
    "alterar_imagem" => "http://$_SERVER[HTTP_HOST]/usuarios/alterar_imagem",
    "deletar_conta" => "http://$_SERVER[HTTP_HOST]/usuarios/deletar",
    "logout" => "http://$_SERVER[HTTP_HOST]/logouturl",
    "create_job" => "http://$_SERVER[HTTP_HOST]/services/create",
    "delete_job" => "http://$_SERVER[HTTP_HOST]/services/delete",
