const vueRoutes = [
  ...
  { path: '/services', name: 'services', component: JobComponent, props: route => ({ servicos: route.query.servicos, categorias: route.query.categorias, homeurl: route.query.homeurl, contatos: route.query.contatos  }) },
