    ...
    <div class="position-absolute w-75">
        <div class="d-flex m-0 justify-content-center">
            <div class="text-center">
                <h1 class="text-white text-uppercase text-center mb-5">
                    Seja Freelancer
                </h1>
...
<main class="padding-md">
    <h1 class="text-muted text-uppercase text-center">JobFinder</h1>
    <hr class="w-25" style="background-color: DarkSlateGray; height: 2px">
...
<section class="container-item-details padding-md">
    <h1 class="text-white text-uppercase text-center mt-5" style="font-size:max(2.5vw, 18pt)">Funcionalidades</h1>
    <hr class="w-25" style="background-color: white; height: 2px">
    ...
    <div class="container-item" id="seguranca">
        <img class="item-img" src="<?php echo $routes->home.'views/public/img/img1.svg'?>" alt="icon_seguranca">
    ...
    <div class="container-item" id="sigilo">
        ...
        <img class="item-img" src="<?php echo $routes->home.'views/public/img/img2.svg'?>" alt="icon_sigilo">
    </div>
    <div class="container-item" id="avaliacao">
        <img class="item-img" src="<?php echo $routes->home.'views/public/img/img3.svg'?>" alt="icon_avaliacao">
        <p class="item-description">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ducimus laboriosam nostrum obcaecati numquam
            perspiciatis quo quibusdam, aperiam dolorum, debitis a.
        </p>
    ...
    <div class="container-item" id="mensageria">
        ...
        <img class="item-img" src="<?php echo $routes->home.'views/public/img/img4.svg'?>" alt="icon_mensageria">
    </div>
    <div class="container-item" id="notificacao">
        <img class="item-img" src="<?php echo $routes->home.'views/public/img/img5.svg'?>" alt="icon_notificacao">
        <p class="item-description">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ducimus laboriosam nostrum obcaecati numquam
            perspiciatis quo quibusdam, aperiam dolorum, debitis a.
        </p>
    ...
    <div class="container-item" id="negociacao">
        ...
        <img class="item-img" src="<?php echo $routes->home.'views/public/img/img6.svg'?>" alt="icon_negociacao">
    </div>
</section>
<footer class="footer-container px-5 pb-1 pt-1 paddind-md" id="footer">
    <div class="d-flex justify-content-around flex-wrap p-5 padding-md">
        <div class="d-flex flex-column">
            <img class="hero-footer" src="<?php echo $routes->home.'views/public/img/logomarca.png'?>" alt="" srcset="">
            <h1 class="text-muted text-uppercase">JobFinder</h1>
        </div>
        <div class="d-flex flex-column">
            <h5 class="text-muted text-uppercase">Nossas redes sociais</h5>
            <span>Nos siga, para mais informações</span>
        ...
        <div class="d-flex flex-column">
            <h5 class="text-muted text-uppercase">Endereço</h5>
            <span>Rua 1, Centro - Afogados da Ingazeira/PE</span>
            <p class="mt-5">
